  ...
  ensures (5 == |q_10_15___seqL_nat_R___6__emit|) && ((forall i : nat | 0 <= i < 5 :: q_10_15___seqL_nat_R___6__emit[i] == 0))
{
  ...
  q_0_compact___seqL__seqL_nat_R__R___7__emit := q_0_1___seqL__seqL_nat_R__R___4__emit;
  q_compact_10___seqL_nat_R___8__emit := q_1_10___seqL_nat_R___5__emit;
  for i := 0 to 9
    invariant 2 == |q_0_compact___seqL__seqL_nat_R__R___7__emit|
    invariant (forall j : nat | 0 <= j < 2 :: (forall k : nat | 0 <= k < 1 + i :: (1 + i == |q_0_compact___seqL__seqL_nat_R__R___7__emit[j]|) && (q_0_compact___seqL__seqL_nat_R__R___7__emit[j][k] == j)))
