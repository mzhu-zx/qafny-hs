...
method Intros1 (N : nat, q_seq'nat'_2__emit : seq<nat>, loc__loc__requires_0_1_0__emit : seq<nat>, loc__loc__requires_0_1_1__emit : nat) returns (q_seq'nat'_8__emit : seq<nat>, loc__loc__requires_0_1_6__emit : seq<nat>, loc__loc__requires_0_1_7__emit : nat)
  requires N >= 2
  ...
  ensures (forall i : nat | 0 <= i < 1 :: 1 == loc__loc__requires_0_1_6__emit[i])
