...
method EntangleOne (base : nat, q_seq'nat'_0__emit : seq<nat>, p_seq'nat'_1__emit : seq<nat>) returns (q_seq'nat'_8__emit : seq<nat>, p_seq'nat'_9__emit : seq<nat>, q_seq'nat'_10__emit : seq<nat>)
  requires 10 == |q_seq'nat'_0__emit|
  requires (forall i : nat | 0 <= i < 10 :: q_seq'nat'_0__emit[i] == 1)
  requires 1 == |p_seq'nat'_1__emit|
  requires (forall i : nat | 0 <= i < 1 :: p_seq'nat'_1__emit[i] == 1)
...
method MultiMod (base : nat, q_seq'nat'_0__emit : seq<nat>, q_seq'nat'_1__emit : seq<nat>, p_seq'nat'_2__emit : seq<nat>) returns (q_seq'nat'_13__emit : seq<nat>, p_seq'nat'_14__emit : seq<nat>)
  requires base >= 3
  requires 9 == |q_seq'nat'_0__emit|
  requires (forall i : nat | 0 <= i < 9 :: q_seq'nat'_0__emit[i] == 1)
  requires 2 == |q_seq'nat'_1__emit|
  requires (forall k : nat | 0 <= k < 2 :: q_seq'nat'_1__emit[k] == k)
  requires 2 == |p_seq'nat'_2__emit|
  requires (forall k : nat | 0 <= k < 2 :: p_seq'nat'_2__emit[k] == (Pow(base, k)) % (10))
  ensures Pow2(10) == |q_seq'nat'_13__emit|
  ensures (forall k : nat | 0 <= k < Pow2(10) :: q_seq'nat'_13__emit[k] == k)
