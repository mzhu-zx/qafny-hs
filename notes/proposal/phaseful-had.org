...
\begin{align}
  & U_f \prs{
    \sum_{x \in \phi_n} \frac{1}{\sqrt{2}} \omega_N^{0} \ket{x} \ket{0}
    +
    \sum_{x \in \phi_n} \frac{1}{\sqrt{2}} \omega_N^{k_x} \ket{x} \ket{1}
    } 
  \\
  =
  & \sum_{x \in \phi_n} \frac{1}{\sqrt{2}} \omega_N^{0} \ket{x} \ket{0 + f(x)}
    +
    \sum_{x \in \phi_n} \frac{1}{\sqrt{2}} \omega_N^{k_x} \ket{x} \ket{1 + f(x)}
  \\
  = 
  ...
  & \sum_{x \in \phi_n} \frac{1}{\sqrt{2^N}}
    ...
    \begin{aligned}
      f(x) = 0 \Rightarrow\ 
      &
        \omega_N^{k_x (0 + 0)} \ket{x} \ket{0}
        +
        \omega_N^{k_x (1 - 0)} \ket{x} \ket{1}
      \\
      f(x) = 1 \Rightarrow\ 
      &
        \omega_N^{k_x (0 + 1)} \ket{x}\ket{0}
        +
        \omega_N^{k_x (1 - 1)} \ket{x} \ket{1}
      \\
    \end{aligned}
    }
  \\
  \equiv
  & \sum_{x \in \phi_n} \frac{1}{\sqrt{2^N}} \omega_N^{k_x (0 + f(x))} \ket{x} \ket{0}
    +
    \sum_{x \in \phi_n} \frac{1}{\sqrt{2^N}} \omega_N^{k_x (1 - f(x))} \ket{x} \ket{1}
  \\
  =
  & \sum_{x \in \phi_n} \frac{1}{\sqrt{2^N}} \omega_N^{k_x \cdot f(x)} \ket{x} \ket{0}
    +
    \sum_{x \in \phi_n} \frac{1}{\sqrt{2^N}} \omega_N^{k_x (1 - f(x))} \ket{x} \ket{1}
\end{align}
#+end_export
